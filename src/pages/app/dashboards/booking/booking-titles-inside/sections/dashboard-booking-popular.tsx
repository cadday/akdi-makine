...
export default function DashboardBookingPopular() {
  ...
  return (
    <Box>
      <Card className="outline-background-paper from-background-paper to-primary-light/10 flex h-89 bg-linear-to-r p-0 outline-4 -outline-offset-4 rtl:bg-linear-to-l">
