          ...
          <Card className="h-24">
            <CardContent className="flex flex-row items-start justify-between">
              ...
              <Box className="relative inline-flex w-10">
                ...
                <Box className="absolute inset-s-0 end-0 top-0 bottom-0 flex items-center justify-center">
                  <Typography variant="caption" component="div" className="text-text-secondary">
                    75%
                  </Typography>
                </Box>
                <Box className="outline-grey-100 absolute inset-s-0 end-0 top-0 bottom-0 z-0 rounded-full outline -outline-offset-2"></Box>
              </Box>
            </CardContent>
          </Card>
        </Grid>
