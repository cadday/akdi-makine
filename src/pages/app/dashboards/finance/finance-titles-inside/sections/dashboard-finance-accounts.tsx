        ...
        <Grid container spacing={2.5} className="flex flex-row">
          <Grid size={{ lg: 4, xs: 12 }}>
            <Card
              ...
              to="#"
            >
              <CardContent className="from-primary-light/3 to-primary-light/10 flex h-80 w-full flex-col justify-between rounded-lg bg-linear-to-b p-6!">
          ...
          <Grid size={{ lg: 4, xs: 12 }}>
            <Card
              ...
              to="#"
            >
              <CardContent className="from-secondary-light/3 to-secondary-light/10 flex h-80 w-full flex-col justify-between rounded-lg bg-linear-to-b p-6!">
          ...
          <Grid size={{ lg: 4, xs: 12 }}>
            <Card
              ...
              to="#"
            >
              <CardContent className="from-accent-1-light/3 to-accent-1-light/10 flex h-80 w-full flex-col justify-between rounded-lg bg-linear-to-b p-6!">
