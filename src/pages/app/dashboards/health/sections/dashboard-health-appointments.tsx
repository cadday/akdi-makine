...
import NiScalpel from "@/icons/nexture/ni-scalpel";

export default function DashboardHealthAppointments() {
    ...
    <>
      ...
      <Card>
        <CardContent>
          <Tabs
            className="flex grow"
            classes={{ list: "gap-2 flex grow pb-2" }}
            value={tabValue}
          ...
          <Box className="px-0">
            ...
            <Box className="flex flex-col gap-4">
              <Box className="flex flex-row gap-2.5">
                <NiHeartRate className="text-primary flex-none"></NiHeartRate>
                <Box className="w-full">
                  <Typography variant="subtitle2">Rheumatologist</Typography>
              ...
              <Box className="flex flex-row gap-2.5">
                <NiScalpel className="text-secondary flex-none"></NiScalpel>
                <Box className="w-full">
                  <Typography variant="subtitle2">Surgeon</Typography>
                  <Box className="flex w-full flex-row justify-between">
                    <Typography variant="body2" className="text-text-secondary">
                      Mia Sullivan
                    </Typography>
              ...
              <Box className="flex flex-row gap-2.5">
                <NiLungs className="text-accent-1 flex-none"></NiLungs>
                <Box className="w-full">
                  <Typography variant="subtitle2">Endocrinologist</Typography>
                  <Box className="flex w-full flex-row justify-between">
                    <Typography variant="body2" className="text-text-secondary">
                      Sofia Bennett
                    </Typography>
