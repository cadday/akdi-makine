        ...
        <Box className="flex flex-1 flex-col gap-4">
          ...
          <Box className="flex flex-col gap-1">
            <Box className="group flex cursor-pointer flex-row" onClick={handleClickOpenDialog}>
              <Typography
                variant="body2"
                className="text-text-disabled-dark group-hover:text-primary flex-1 px-2.5 leading-6 font-medium transition-colors"
              >
                Recent Chats
              </Typography>
      ...
      >
        ...
        <DialogContent className="flex flex-col pt-6 pb-0">
          <Box className="flex flex-col gap-2.5">
            <Box>
              <Typography variant="body2" className="text-text-disabled-dark mb-2 font-bold">
                Today
              </Typography>
              <List>
