      ...
      <Box ref={anchorRef}>
        ...
        >
          ...
          <Avatar
            ...
            className={cn("large transition-all group-hover:ms-0.5 group-hover:h-8 group-hover:w-8", open && "ms-0.5 h-8! w-8!")}
          />
        </Button>
        {/* Desktop button */}
        ...
        <Button
          ...
          color='text-primary'
          className={cn(
            "icon-only hover:bg-grey-75 hover-icon-shrink [&.active]:text-primary group ms-1 me-1 p-0! hover:p-1.5! md:hidden",
            open && "active bg-grey-75 p-1.5!",
          )}
          onClick={handleToggle}
          startIcon={
            <Avatar
                ...
                <Card className='shadow-darker-sm!'>
                  <CardContent>
                    <Box className='max-w-64 sm:w-72 sm:max-w-none'>
                      ...
                      <Button component={Link} to='/auth/sign-in' variant='outlined' size='tiny' color='grey' className='w-full'>
                        {t("user-sign-out")}
                      </Button>
                    </Box>
                  </CardContent>
