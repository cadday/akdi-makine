...
export default function VersionSelect({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      >
        <Box className="w-full truncate text-clip">Vite v8.3.1</Box>
      </Button>
      <Menu
      ...
      >
        ...
        <MenuItem onClick={handleClose}>Vite v8.3.0</MenuItem>
        <MenuItem onClick={handleClose}>Vite v8.2.0</MenuItem>
        <MenuItem onClick={handleClose}>Vite v8.1.0</MenuItem>
      </Menu>
    </>
  );
}
