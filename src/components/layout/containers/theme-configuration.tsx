...
import { LINKS, ModeVariant, THEME_OPTIONS } from "@/constants";
...
export default function ThemeConfiguration() {
  ...
  return (
    <>
      <Box className="bg-background-paper shadow-darker-xs fixed inset-e-0 top-1/2 flex w-15 -translate-y-1/2 flex-col gap-2 rounded-s-3xl p-2.5">
